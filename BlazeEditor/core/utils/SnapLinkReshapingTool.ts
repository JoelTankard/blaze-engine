...
export class SnapLinkReshapingTool extends go.LinkReshapingTool {
  ...
  set gridCellSize (val: go.Size) {
    if (!(val instanceof go.Size)) { throw new TypeError('new value for SnapLinkReshapingTool.gridCellSize must be a Size, not: ' + val) }
  ...
  set gridOrigin (val: go.Point) {
    if (!(val instanceof go.Point)) { throw new TypeError('new value for SnapLinkReshapingTool.gridOrigin must be a Point, not: ' + val) }
  ...
  set isGridSnapEnabled (val: boolean) {
    if (typeof val !== 'boolean') { throw new TypeError('new value for SnapLinkReshapingTool.isGridSnapEnabled must be a boolean, not: ' + val) }
  ...
  set avoidsNodes (val: boolean) {
    if (typeof val !== 'boolean') { throw new TypeError('new value for SnapLinkReshapingTool.avoidsNodes must be a boolean, not: ' + val) }
